...
def create_post():
    ...
    if form.validate_on_submit():
        lesson = Lesson(title=form.title.data, content=form.content.data, user_id=current_user.id, date_of_lesson=form.date_of_lesson.data, subject=form.subject.data)
